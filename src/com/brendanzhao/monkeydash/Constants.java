...
public final class Constants {
	...
	public static final int CONSUMABLE_LEVITATION_HEIGHT = 150;
	...
	public static final int CONSUMABLE_DISTANCE_MIN = 2000;
	public static final int CONSUMABLE_DISTANCE_RANDOM = 1001;
	...
	public static final int INITIAL_NUMBER_CONSUMABLES = 2;
	public static final int INITIAL_NUMBER_BLOCKS = 3;
	public static final int INITIAL_BLOCK_X = 500;
	public static final int INITIAL_CONSUMABLE_X = 1100;
